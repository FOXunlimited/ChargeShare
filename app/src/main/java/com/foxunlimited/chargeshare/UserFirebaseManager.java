...
public class UserFirebaseManager {
    ...
    public static void AddPurpose(User user, LatLng coords, String phone, String description) {
        ...
        Firebase userRef;
        userRef =  ref.child("users").child(user.userId).child("Lat");
        userRef.setValue(info.Lat);
        userRef = ref.child("users").child(user.userId).child("Lng");
        userRef.setValue(info.Lng);
        userRef = ref.child("users").child(user.userId).child("phone");
        userRef.setValue(info.phone);
        userRef = ref.child("users").child(user.userId).child("description");
